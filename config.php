<?php
    ...
    $link = 'https://ws.sandbox.pagseguro.uol.com.br/v2/sessions?
    ...
    curl_setopt($_curl, CURLOPT_HTTPHEADER, array("Content-Type: application/x-www-form-urlencoded; charset=UTF-8"));
